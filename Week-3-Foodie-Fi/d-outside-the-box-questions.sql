...
> **Data engineering note:** The current schema only tracks subscriptions. To fully analyse these journeys, additional tables are needed — login events, watch history, content interactions.
